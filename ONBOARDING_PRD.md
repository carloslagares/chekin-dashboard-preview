...
**Reference code:** [`onboarding.html`](onboarding.html) · [`variants/v9_firstrun.html`](variants/v9_firstrun.html) (vanilla HTML/CSS/JS; recreate in the product stack, do not copy internal structure)
...
```
index.html                      ← variant switcher (iframe). Default: V8 dashboard
onboarding.html                 ← 5-step wizard (no sidebar)
variants/v8_fable.html          ← "live" dashboard (final destination)
variants/v9_firstrun.html       ← First-run Home (post-onboarding landing)
ds/_sidebar.{js,css}            ← shared sidebar (account block collapsed by default)
```
...
> All links use base `https://carloslagares.github.io/chekin-dashboard-preview/`.
